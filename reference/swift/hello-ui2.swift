...
// This more-verbose example doesn't have the same window focus problems
...
extension NSApplication {
  var customMenu: NSMenu {
    ...
    windowMenu.submenu?.addItem(
      NSMenuItem(
        title: "Show All", action: #selector(NSApplication.arrangeInFront(_:)), keyEquivalent: "m"))
